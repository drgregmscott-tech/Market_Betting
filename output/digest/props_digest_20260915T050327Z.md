# Props Pipeline Digest -- 2026-09-15T05:03:27Z

## Run summary
- DraftKings ingestion: 48 rows across 8 events (OK)
- FanDuel ingestion: 0 rows (OK)
- BetMGM ingestion (via Rotowire): 0 rows (OK)
- Estimation: 48 rows written (from 48 ingested rows) -- status breakdown: {'insufficient_history': 46, 'no_player_match': 2}
